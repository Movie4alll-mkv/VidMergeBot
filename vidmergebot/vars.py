...
class Vars:
    ...
    STREAMTAPE_DEFAULT = os.environ.get("STREAMTAPE_DEFAULT", default=None, cast=config.boolean)
    ...
    JOIN_CHECK = os.environ.get("JOIN_CHECK", default=None, cast=config.boolean)
