...
class Vars:
    ...
    STREAMTAPE_DEFAULT = os.environ.get("STREAMTAPE_DEFAULT", default=None, cast=os.environ.get.boolean)
    ...
    JOIN_CHECK = os.environ.get("JOIN_CHECK", default=None, cast=os.environ.get.boolean)
    ...
    LIMIT_USER_USAGE = os.environ.get("LIMIT_USER_USAGE", default=None,cast=os.environ.get.boolean)
